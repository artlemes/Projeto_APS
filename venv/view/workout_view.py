...
class WorkoutView:
    ...
    def update_workout(self, workout):
        ...
        # Botão de criar
        Button(container, text="Update", font=("Arial", 12), bg="#4CAF50", fg="black", command=lambda: self.input_validation(workout), width=50, height=2).pack(pady=(20, 10))
    ...
    def input_validation(self, workout):
